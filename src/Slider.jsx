...
export default function Slider() {
    ...
    return (
        <div className="flex justify-center text-gray-900 mb-10 mt-10">
            <div className="swiper w-1/2 rounded-lg shadow-md backdrop-blur-lg border border-gray-900 border-2">
                    ...
                    <div className="swiper-slide relative">
                        <Link to="/reactionTime" className="block h-full w-full">
                            ...
                            <div className="absolute pb-10 bottom-0 left-0 right-0 bg-gradient-to-t from-cyan-500/90 to-transparent p-4">
                                <h1 className="text-3xl mb-2 font-bold">Reaction time</h1>
                                <p className="text-xl">Test your reaction time by clicking on the screen as fast as possible when the box changes color.</p>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="swiper-slide relative">
                        <Link to="/numberMemory" className="block h-full w-full">
                            ...
                            <div className="absolute bottom-0 pb-10 left-0 right-0 bg-gradient-to-t from-cyan-500/90 to-transparent p-4">
                                <h1 className="text-3xl mb-2 font-bold">Number memory</h1>
                                <p className="text-xl">Test your number memory by memorizing an increasing sequence of numbers.</p>
                            </div>
                        </Link>
                    </div>
                    <div className="swiper-slide relative">
                        <Link to="/wordsMemory" className="block h-full w-full">
                            ...
                            <div className="absolute bottom-0 pb-10 left-0 right-0 bg-gradient-to-t from-cyan-500/90 to-transparent p-4">
                                <h1 className="text-3xl mb-2 font-bold">Words memory</h1>
                                <p className="text-xl">Test your words memory by memorizing as much words as possible.</p>
                            </div>
                        </Link>
                    </div>
                </div>
