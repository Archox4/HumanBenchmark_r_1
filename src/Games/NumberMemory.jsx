            ...
            <div className="flex h-fit items-center flex-col w-full">
                ...
                {gameState === 2 &&(
                    <>
                        ...
                        <input name="num_input" ref={inputNumber} autoFocus type="number" className="bg-gray-700 mt-4 shadow-2xl shadow-cyan-700 text-center text-3xl p-1 text-gray-100 border-2 border-gray-800 rounded-xl w-1/2 mb-6" />
                    </>
                )}
                {gameState === 1 &&(
                    <>
                        <ProgressBar duration={level * 1000}/>
                        <h4 className="text-cyan-500 mt-4 text-2xl">{guessing}</h4>
                    </>
